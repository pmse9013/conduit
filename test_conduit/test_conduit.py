...
class TestConduit(object):
    ...
    def test_sign_in(self):
        ...
        element = WebDriverWait(
            self.driver, 5).until(
            EC.visibility_of_element_located((By.XPATH, "//div[contains(text(), 'Your registration was successful!')]"))
        )
    ...
    def test_change_bio(self):
        ...
        element = WebDriverWait(
            ...
            EC.visibility_of_element_located((By.XPATH, "//div[contains(text(),'Update successful!')]"))
        )
        self.driver.find_element_by_xpath("//button[contains(text(),'OK')]").click()
        time.sleep(3)
